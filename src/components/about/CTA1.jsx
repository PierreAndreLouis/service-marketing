...
const CTA1 = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 relative py-20 pb-40">
      ...
      >
        <div className="blur-[106px] h-56 bg-gradient-to-br from-indigo-500 to-purple-400 dark:from-blue-700"></div>
          ...
          <div className="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Link
                ...
                to="/reservation"
                className="relative flex h-12 w-full items-center justify-center px-8 before:absolute before:inset-0 before:rounded-full before:bg-indigo-500 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max"
              >
              ...
              >
                <span className="relative text-base font-semibold text-indigo-500 dark:text-white">
                  En savoir plus
                </span>
              </a> */}
            </div>
