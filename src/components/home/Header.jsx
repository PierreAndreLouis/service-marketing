    ...
    <div className="fixed z-[99999] bg-white dark:bg-gray-900 top-0 left-0 right-0">
      <div className="px-8  shadow-lg shadow-gray-500/20 md:px-14 py-2 md:flex justify-between">
        <div className="flex justify-between items-center">
          ...
          >
            <img
              className="w-[2rem] h-[2rem] object-cover rounded-full object-top bg-indigo-500 "
              src="/assets/profil2.png"
              alt=""
            />
            <p>
              Pierre-<span className="text-indigo-500">Andre</span>{" "}
            </p>
          </Link>
          {/* <div
            onClick={() => {
        ...
        >
          <ul className="flex md:flex-row w-full gap-2 flex-col pt-6 md:pt-0 justify-center items-center">
            <Link
              ...
              className={`${
                tab === "home" ? "text-indigo-500" : ""
              } hover:bg-indigo-500 md:hover:bg-indigo-50/0 dark:text-gray-100 font-semibold md:hover:text-indigo-500 w-full text-center py-1 rounded-lg cursor-pointer hover:text-white `}
            >
              Home
            </Link>
            <Link
          ...
          <Link
            ...
            className="border font-semibold mb-6 md:hidden px-4 hover:bg-indigo-500 hover:text-white cursor-pointer text-indigo-500 border-indigo-500 w-full text-center py-1 rounded-lg"
          >
            Rendez-vous
          </Link>
        </div>
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            to="/reservation?tab=contact"
            className="border font-semibold hidden md:block px-4 hover:bg-indigo-500 hover:text-white cursor-pointer text-white bg-indigo-500 border-indigo-500  text-center py-1 rounded-lg"
          >
            Rendez-vous
          </Link>
        </div>
